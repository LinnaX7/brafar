...
public class JDIDebugger {
    public final static String JUNIT_TEST_RUNNER = "repairjava.entity.monitor.SingleJUnitTestRunner";
    public final static String JDI_DEBUGGER = "repairjava.entity.monitor.JDIDebugger";
